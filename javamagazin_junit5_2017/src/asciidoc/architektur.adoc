...
und sich über den normalen _ServiceLoader_-Mechanismus der JVM
[referenz: https://docs.oracle.com/javase/8/docs/api/java/util/ServiceLoader.html]
...
z.B. die jqwik-Engine für Property-Based Testing [ REFerenz ]
oder das BDD-Framework Specsy. [ REFerenz ]
